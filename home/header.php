...
<head>
    ...
    <title>shared center contact</title>
...
<div class="container bootstrap snippets bootdey">
  ...
  <div class="row">
    <div class="col-md-3">
      ...
      <a href="../index.php"><button type="submit" class="btn btn-danger w-33" id="submitButton" ><i class="fa fa-sign-out" aria-hidden="true"></i> Deconnexion</button></a>
      ...
      <div class="col-md-9">   	
      <!-- column 2 -->	
       <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i> </strong></a>     
       <hr>
	   <div class="row">
            <!-- center left-->	
         	<div class="col-md-12">
